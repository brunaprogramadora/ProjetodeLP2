...
-- Copiando estrutura para tabela information_schema.INNODB_CHANGED_PAGES
...
-- Copiando estrutura para tabela information_schema.XTRADB_INTERNAL_HASH_TABLES
...
-- Copiando estrutura para tabela information_schema.XTRADB_READ_VIEW
...
-- Copiando estrutura para tabela information_schema.XTRADB_RSEG
...
-- Copiando estrutura para tabela mysql.columns_priv
...
-- Copiando estrutura para tabela mysql.column_stats
...
-- Copiando estrutura para tabela mysql.db
...
-- Copiando estrutura para tabela mysql.event
...
-- Copiando estrutura para tabela mysql.func
...
-- Copiando estrutura para tabela mysql.general_log
...
-- Copiando estrutura para tabela mysql.gtid_slave_pos
...
-- Copiando estrutura para tabela mysql.help_category
...
-- Copiando estrutura para tabela mysql.help_keyword
...
-- Copiando estrutura para tabela mysql.help_relation
...
-- Copiando estrutura para tabela mysql.help_topic
...
-- Copiando estrutura para tabela mysql.host
...
-- Copiando estrutura para tabela mysql.index_stats
...
-- Copiando estrutura para tabela mysql.innodb_index_stats
...
-- Copiando estrutura para tabela mysql.innodb_table_stats
...
-- Copiando estrutura para tabela mysql.plugin
...
-- Copiando estrutura para tabela mysql.proc
...
-- Copiando estrutura para tabela mysql.procs_priv
...
-- Copiando estrutura para tabela mysql.proxies_priv
...
-- Copiando estrutura para tabela mysql.roles_mapping
...
-- Copiando estrutura para tabela mysql.servers
...
-- Copiando estrutura para tabela mysql.slow_log
...
-- Copiando estrutura para tabela mysql.tables_priv
...
-- Copiando estrutura para tabela mysql.table_stats
...
-- Copiando estrutura para tabela mysql.time_zone
...
-- Copiando estrutura para tabela mysql.time_zone_leap_second
...
-- Copiando estrutura para tabela mysql.time_zone_name
...
-- Copiando estrutura para tabela mysql.time_zone_transition
...
-- Copiando estrutura para tabela mysql.time_zone_transition_type
...
-- Copiando estrutura para tabela mysql.user
...
-- Copiando estrutura do banco de dados para performance_schema
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `performance_schema`;


-- Copiando estrutura para tabela performance_schema.accounts
...
-- Copiando estrutura para tabela performance_schema.cond_instances
...
-- Copiando estrutura para tabela performance_schema.events_stages_current
...
-- Copiando estrutura para tabela performance_schema.events_stages_history
...
-- Copiando estrutura para tabela performance_schema.events_stages_history_long
...
-- Copiando estrutura para tabela performance_schema.events_stages_summary_by_account_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_stages_summary_by_host_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_stages_summary_by_thread_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_stages_summary_by_user_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_stages_summary_global_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_statements_current
...
-- Copiando estrutura para tabela performance_schema.events_statements_history
...
-- Copiando estrutura para tabela performance_schema.events_statements_history_long
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_by_account_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_by_digest
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_by_host_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_by_thread_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_by_user_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_statements_summary_global_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_waits_current
...
-- Copiando estrutura para tabela performance_schema.events_waits_history
...
-- Copiando estrutura para tabela performance_schema.events_waits_history_long
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_by_account_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_by_host_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_by_instance
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_by_thread_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_by_user_by_event_name
...
-- Copiando estrutura para tabela performance_schema.events_waits_summary_global_by_event_name
...
-- Copiando estrutura para tabela performance_schema.file_instances
...
-- Copiando estrutura para tabela performance_schema.file_summary_by_event_name
...
-- Copiando estrutura para tabela performance_schema.file_summary_by_instance
...
-- Copiando estrutura para tabela performance_schema.hosts
...
-- Copiando estrutura para tabela performance_schema.host_cache
...
-- Copiando estrutura para tabela performance_schema.mutex_instances
...
-- Copiando estrutura para tabela performance_schema.objects_summary_global_by_type
...
-- Copiando estrutura para tabela performance_schema.performance_timers
...
-- Copiando estrutura para tabela performance_schema.rwlock_instances
...
-- Copiando estrutura para tabela performance_schema.session_account_connect_attrs
...
-- Copiando estrutura para tabela performance_schema.session_connect_attrs
...
-- Copiando estrutura para tabela performance_schema.setup_actors
...
-- Copiando estrutura para tabela performance_schema.setup_consumers
...
-- Copiando estrutura para tabela performance_schema.setup_instruments
...
-- Copiando estrutura para tabela performance_schema.setup_objects
...
-- Copiando estrutura para tabela performance_schema.setup_timers
...
-- Copiando estrutura para tabela performance_schema.socket_instances
...
-- Copiando estrutura para tabela performance_schema.socket_summary_by_event_name
...
-- Copiando estrutura para tabela performance_schema.socket_summary_by_instance
...
-- Copiando estrutura para tabela performance_schema.table_io_waits_summary_by_index_usage
...
-- Copiando estrutura para tabela performance_schema.table_io_waits_summary_by_table
...
-- Copiando estrutura para tabela performance_schema.table_lock_waits_summary_by_table
...
-- Copiando estrutura para tabela performance_schema.threads
...
-- Copiando estrutura para tabela performance_schema.users
